  ...
  candidateJobExperienceAdd() {
    ...
    if (this.candidateJobExperienceForm.valid) {
      ...
      let candidateJobExperience: CandidateJobExperience = {
        ...
        positionId: this.candidateJobExperienceForm.value,
        quitYear: this.candidateJobExperienceForm.value,
        startYear: this.candidateJobExperienceForm.value,
        workPlace: this.candidateJobExperienceForm.value
      }
